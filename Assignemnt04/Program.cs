...
namespace Assignemnt04
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(D1 + D2); //Hours: 2, Minutes: 10, Seconds: 15
            Console.WriteLine(D1 + 7800); //Hours: 3, Minutes: 20, Seconds: 15
            Console.WriteLine(666 + D3); //Hours: 2, Minutes: 21, Seconds: 6

            Console.WriteLine("===========================================================================================");

            D3 = ++D1;
            Console.WriteLine(D1); //Hours: 1, Minutes: 11, Seconds: 15

            D3 = --D1;
            Console.WriteLine(D1); //Hours: 0, Minutes: 10, Seconds: 15
